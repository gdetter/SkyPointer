...
def digitalRead8(pin):
    return _wiringpi.digitalRead8(pin)

def digitalWrite8(pin, value):
    return _wiringpi.digitalWrite8(pin, value)
...
def piBoardId(model):
    return _wiringpi.piBoardId(model)
...
def H618_set_pwm_reg(pin, sunxi_gpio_info_ptr):
    return _wiringpi.H618_set_pwm_reg(pin, sunxi_gpio_info_ptr)

def s905d3_set_gpio_reg(pin, s905d3_gpio_info_ptr):
    return _wiringpi.s905d3_set_gpio_reg(pin, s905d3_gpio_info_ptr)

def rk3588_set_pwm_reg(pin, rk3588_soc_info_ptr):
    return _wiringpi.rk3588_set_pwm_reg(pin, rk3588_soc_info_ptr)

def rk3566_set_pwm_reg(pin, rk3566_soc_info_ptr):
    return _wiringpi.rk3566_set_pwm_reg(pin, rk3566_soc_info_ptr)

def sunxi_pwm_set_enable(en):
    return _wiringpi.sunxi_pwm_set_enable(en)

def pwmToneWrite(pin, freq):
    return _wiringpi.pwmToneWrite(pin, freq)

def pwmSetMode(pin, mode):
    return _wiringpi.pwmSetMode(pin, mode)

def pwmSetRange(pin, range):
    return _wiringpi.pwmSetRange(pin, range)

def pwmSetClock(pin, divisor):
    return _wiringpi.pwmSetClock(pin, divisor)
...
def readR(addr):
    return _wiringpi.readR(addr)

def writeR(val, addr):
    return _wiringpi.writeR(val, addr)

def orangepi_get_gpio_mode(pin):
    return _wiringpi.orangepi_get_gpio_mode(pin)

def orangepi_set_gpio_mode(pin, mode):
    return _wiringpi.orangepi_set_gpio_mode(pin, mode)

def orangepi_digitalRead(pin):
    return _wiringpi.orangepi_digitalRead(pin)

def orangepi_digitalWrite(pin, value):
    return _wiringpi.orangepi_digitalWrite(pin, value)

def orangepi_set_gpio_alt(pin, mode):
    return _wiringpi.orangepi_set_gpio_alt(pin, mode)

def OrangePi_set_gpio_pullUpDnControl(pin, pud):
    return _wiringpi.OrangePi_set_gpio_pullUpDnControl(pin, pud)

def orangepi_pwm_set_act(pin, act_cys):
    return _wiringpi.orangepi_pwm_set_act(pin, act_cys)

def orangepi_pwm_set_period(pin, period_cys):
    return _wiringpi.orangepi_pwm_set_period(pin, period_cys)

def orangepi_pwm_set_clk(pin, clk):
    return _wiringpi.orangepi_pwm_set_clk(pin, clk)

def orangepi_pwm_set_tone(pin, freq):
    return _wiringpi.orangepi_pwm_set_tone(pin, freq)

def set_soc_info():
    return _wiringpi.set_soc_info()
...
def wiringPiSPISetupMode(channel, port, speed, mode):
    return _wiringpi.wiringPiSPISetupMode(channel, port, speed, mode)
