...
class StepperDriver:
    ...
    def rotate_degrees(self, angle):
        ...
        """
        steps = int(angle*self.ratio*self._microstep/self.DEGREES_PER_STEP)
        ...
        #Return actual degrees moved
        return (steps*self.DEGREES_PER_STEP)/(self.ratio*self.microstep)
